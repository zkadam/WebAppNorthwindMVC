...
namespace WebAppEka.Controllers
{
    public class ContactsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactID,ContactType,CompanyName,ContactName,ContactTitle,Address,City,Region,PostalCode,Country,Phone,Extension,Fax,HomePage,PhotoPath,Photo,kuva")] Contacts contacts)
        {
            if (ModelState.IsValid)
            {
                //kuvan lisäys
                ...
                //kuvan lisäys2
                contacts.Photo = buffer;
                contacts.PhotoPath = filename;
